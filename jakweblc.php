<?php
/*
Plugin Name: Zipp.Chat
Plugin URI: https://zipp.chat
Description: Will embed the live support chat from Zipp.Chat with extra settings.
Version: 0.1
Author: JAKWEB
Text Domain: zipp-live-chat
*/
if(!class_exists('jakwebLC_Settings')){
	...
	class jakwebLC_Settings{
		...
		public function add_menu(){
			add_options_page(
				__('Zipp.Chat Settings','zipp-live-chat'),
				__('Zipp.Chat','zipp-live-chat'),
				'manage_options',
				'zipp_chat',
...
if(!class_exists('JakwebLC')){
	class JakwebLC{
		public function __construct(){
			...
			add_shortcode( 'zipp.chat', array($this,'shortcode_print_embed_code') );
