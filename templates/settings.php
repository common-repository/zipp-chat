...
<div id="jakweblc">
  <div class="wrap">
    ...
    <img style="width: 250px; height: 66px;" src="<?php echo plugins_url( 'assets/zippchat-logo.png' , dirname(__FILE__) ) ?>">
    <span>brought to you by JAKWEB</span>
    </div>
    <div class="clear"></div>
    ...
    <div class="metabox-holder">
      <div class="postbox">
        <h3>Do you already have a Zipp.Chat account?</h3>
    ...
    <!-- No account show the form to register zipp.chat -->
    <div class="metabox-holder" id="jakweblc_nohave">
      <div class="postbox">
      <form method="post" class="jak-ajaxform">
        <h3>Create new Zipp.Chat account</h3>
        <div class="postbox_content">
    ...
    <?php } else { ?>
    <p><a class="button-primary" href="https://zipp.chat/talk/operator" target="_blank">Login to Zipp.Chat</a> <a class="button-primary" href="https://zipp.chat/applications.html" target="_blank">Download Desktop App</a></p>
    <p>Your WidgetID is: <strong><?php echo $lc_embedid;?></strong></p>
    <p>Don't forget to <a href="https://zipp.chat/faq.html">whitelist your domain</a> in Zipp.Chat Widget section: <strong><?php echo get_site_url();?></strong>
    ...
    <div class="metabox-holder">
      ...
      <form method="post" action="?page=zipp_chat">
        <h3>Options</h3>
        <p class="jak-left">You can use the options below or add the live support chat to any page individually with following shortcode: <strong>[zipp.chat]</strong>
        <div class="postbox_content">
          <p>Show Everywhere?</p>
          <ul id="jakweblc_account">
